## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `ElevenLabs API Documentation`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the ElevenLabs API Documentation API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | ElevenLabsAPIDocumentation                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | elevenlabs-api-documentation                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | ElevenLabsAPIDocumentationConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | ElevenLabsAPIDocumentationRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| ElevenLabsAPIDocumentation.Client    | use the "dispatch" functions to send requests       |
| ElevenLabsAPIDocumentation.Core      | core functions, config and request types            |
| ElevenLabsAPIDocumentation.API       | construct api requests                              |
| ElevenLabsAPIDocumentation.Model     | describes api models                                |
| ElevenLabsAPIDocumentation.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| ElevenLabsAPIDocumentation.ModelLens | lenses for model fields                             |
| ElevenLabsAPIDocumentation.Logging   | logging functions and utils                         |
