...
{-|
Module : ElevenLabsAPIDocumentation.MimeTypes
-}
...
module ElevenLabsAPIDocumentation.MimeTypes where
...
data MimeAudioMpeg = MimeAudioMpeg deriving (P.Typeable)

-- | @audio/mpeg@
instance MimeType MimeAudioMpeg where
  mimeType _ = Just $ P.fromString "audio/mpeg"
-- instance MimeRender MimeAudioMpeg T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeAudioMpeg T.Text where mimeUnrender _ = undefined
