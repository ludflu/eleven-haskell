...
module ElevenLabsAPIDocumentation.Client where
...
dispatchLbs
  ...
  -> ElevenLabsAPIDocumentationConfig -- ^ config
  -> ElevenLabsAPIDocumentationRequest req contentType res accept -- ^ request
